...
<body style='background-color:red'>
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-80 col-lg-120 col-md-100">

        <div class="card 4-hidden border-1 shadow-lg my-5 bg-gradient-warning">
          <div class="card-body p-10">
            
            <!-- Nested Row within Card Body -->
            <div class="row bg-gradient-warning">
              <div class="col-lg-7 d-none d-lg-block bg-login bg-gradient-warning">
                <img src="sistema/img/LOGO.jpg" class="img-thumbnail bg-gradient-warning">
              </div>
              ...
              <div class="col-lg-5">
                ...
                <div class="p-10">
                  <div class="text-center">
                    <h1 class="h1 text-gray-900 mb-100 bg-gradient-warning">Iniciar Sesión</h1>
                  </div>
                  <form class="user text-gray-900" method="POST">
