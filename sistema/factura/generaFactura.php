<?php
	...
	if(empty($_REQUEST['cl']) || empty($_REQUEST['f']))
	{
		...
		$pdf->image("img/LOGO.jpg", 55, 5, 20, 20, 'JPG');
		
		$pdf->SetFont('Arial', 'B', 19);
		$pdf->Cell(40, 5, utf8_decode($resultado['nombre']), 0, 1, 'C');
		$pdf->Ln();


		$pdf->Cell(60, 5, "", 0, 1, 'L');
		$pdf->SetFont('Arial', 'B', 8);
		$pdf->Cell(12, 5, "Ruc: ", 0, 0, 'L');
		$pdf->SetFont('Arial', '', 8);
		$pdf->Cell(10, 5, $resultado['dni'], 0, 1, 'L');
		$pdf->SetFont('Arial', 'B', 8);
		$pdf->Cell(12, 5, utf8_decode("Celular: "), 0, 0, 'L');
		$pdf->SetFont('Arial', '', 8);
		$pdf->Cell(20, 5, $resultado['telefono'], 0, 1, 'L');
		$pdf->SetFont('Arial', 'B', 8);
		$pdf->Cell(13, 5, utf8_decode("Dirección: "), 0, 0, 'L');
		$pdf->SetFont('Arial', '', 8);
		...
		$pdf->Cell(28, 5, $result_venta['fecha'], 0, 1, 'R');
		$pdf->SetFont('Arial', 'B', 8);
